...
import { setLatestRequestData } from './slices/latestRequestDataSlice';
...
const App = () => {
  ...
  useEffect(() => {
    (async () => {
      isAuthenticated ?? (await checkAuthenticity());
      isAuthenticated ? navigate('/collections') : navigate('/login');
    })();
